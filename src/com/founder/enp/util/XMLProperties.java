/*
 * $Logfile: /chinadaily/enp/src/com/founder/enp/util/XMLProperties.java $
 * $Revision: 1 $
 * $Date: 06-07-20 23:04 $
 * $Author: Liu_dong $
 * $History: XMLProperties.java $
 * 
 * *****************  Version 1  *****************
 ...
 * to disk.
 * 
 * 为了使XML文件可以包含中文信息，就要求XML的编码方式的指定由<code>UTF-8</code>改为<code>GBK</code>
 * 
 * @author Liudong
 * @version 1.0
 * Date:2003-11-2
...
public class XMLProperties
{
	 ...
	 * 修改原来build方法的参数，将原来直接传文件改为传编码后的Reader
	 *
	...
	private synchronized void saveProperties()
	{
		...
		try
		{
            ...
            Format format = outputter.getFormat().setEncoding(enc);
            outputter.setFormat(format);
			outputter.output(doc, out);
		}
		catch (Exception e)
		{
			System.out.println("Can not write 'config.xml'!");
			e.printStackTrace();
